...
# ----------------------- Load and Save on App Start -----------------------
if "initialized" not in st.session_state:
    st.session_state.initialized = True
    load_data()

# 🔁 Hook to auto-save after session state updates ------------------------
# This ensures changes persist after refresh if manual save_data() was missed
...
# ✅ You can now continue your app logic below this block...
